...
- **Linux (x86_64)** — glibc ≥ 2.17 的发行版（CentOS 7 / Ubuntu 20.04+ /
...
```powershell
# Windows
Get-FileHash frampp-<version>-windows-x64.exe -Algorithm SHA256

# Linux
sha256sum frampp-<version>-linux-x86_64.run
```
